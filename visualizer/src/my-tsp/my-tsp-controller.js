      ...
      <div nav="">
        ...
        <div>
          ...
          <paper-radio-group id="solvers" selected="output">
            ...
            <paper-radio-button name="sample/random"
              >sample/random</paper-radio-button
            >
            <paper-radio-button name="sample/greedy"
              >sample/greedy</paper-radio-button
            >
        ...
        <div>
          ...
          <div>
            <a
              href="https://github.com/hayatoito/google-step-tsp/blob/main/README.md"
              >README</a
            >
          </div>
        </div>
